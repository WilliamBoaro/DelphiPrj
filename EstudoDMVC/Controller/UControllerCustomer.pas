...
//Sample CRUD Actions for a "Customer" entity
procedure TCustomerController.GetCustomers;                //somente é possível utilizar uma vez

begin
  Render(ObjectDict.Add('data', TMVCActiveRecord.All<Tcustomer>));
end;

procedure TCustomerController.GetCustomer(id: Integer);    //somente é possível utilizar uma vez
var
...
procedure TCustomerController.CreateCustomer;             //Está funcionando (talvez tratar o erros)
var
  ObCustomer : Tcustomer;
begin
